...
- [ ] **BRAND-04**: A single accent color is applied consistently across primary buttons, links, and key UI highlights, defined as a Tailwind theme token / CSS custom property (so future palette changes are one-line).
