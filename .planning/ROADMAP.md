...
- [x] 07-07-PLAN.md — Wave 5: DEP-05 — migration 0006_cron_prod_url_cutover.sql + apply to prod (depends on 07-06)
- [x] 07-08-PLAN.md — Wave 6: DEP-01/06 — synthesis end-to-end UAT + PITFALLS.md:336-348 inspection grid + screenshots (depends on 07-07)
**UI hint**: yes
